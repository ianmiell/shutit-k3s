...
EOF''')
	# Give time for the policy to take effect
	...
	# This should not have an automountServiceAccountToken item in it
	shutit_session.send('kubectl get sa -o yaml b2')
